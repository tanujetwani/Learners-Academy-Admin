...
<title>List source Destination page</title>
</head>
<body>
...
<tr>
 ...
 <%         try{ 
                 ...
                 rs=stmt.executeQuery("Select source, destination from flights group by source,destination");
 ...
 <%           
                ...
                if(empty){
               	 out.println("<br><br>No data of places for source and destination in database" );
                }
          } //End of try
...
<br><br><br><a href="logout.jsp">Click here to  logout</a></body>
</html>